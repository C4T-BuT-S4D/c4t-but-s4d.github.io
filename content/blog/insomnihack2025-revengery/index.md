...
tldr: "forge the ECDSA signature and recover the desired address"
date: "2025-03-17T19:14:33+03:00"
tags: [web3, crypto]
summary: |
  A web3 challenge written in Solidity. The main goal is to takeover the ownership of the vulnerable contract using the ECDSA signature forgery.
---
...
> 
> You need first to provide a Proof-of-Work before deploying the
> contract. The script deploy_contract.py shows how to do it.
